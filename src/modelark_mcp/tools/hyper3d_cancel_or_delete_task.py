"""``hyper3d_cancel_or_delete_task`` tool — cancel or delete a Hyper3D task."""
...
async def hyper3d_cancel_or_delete_task(
    input: Seed3DCancelOrDeleteInput, ctx: Context
) -> Seed3DCancelOrDeleteOutput | ToolResult:
    """Cancel (queued) or delete (terminal) a Hyper3D 3D generation task.
    ...
    """
    return await seed3d_cancel_or_delete_impl(input, ctx, "hyper3d")
