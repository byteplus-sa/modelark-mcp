...
TOOL_REQUESTS = Counter(
    "ark_mcp_tool_requests_total",
    "MCP tool requests by tool and outcome.",
    ("tool", "status"),
)
TOOL_DURATION = Histogram(
    "ark_mcp_tool_duration_seconds",
