"""Structured stderr logger for the Ark Seed MCP server.
...
Supports log level filtering via the ``ARK_LOG_LEVEL`` environment variable
(default: INFO).
"""
...
_CURRENT_LEVEL: int = _LEVELS.get(os.environ.get("ARK_LOG_LEVEL", "INFO").upper(), 20)
